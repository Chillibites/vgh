...
import { Truck, Globe, Clock, ArrowRight } from 'lucide-react';
...
export const metadata = {
  title: 'Our Services',
  description:
    'Discover our advanced logistics solutions including Road Freight, International Shipping, and Express Delivery.',
};
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            ...
            our comprehensive solutions can boost your business efficiency.
          </p>
          <Link href="/contact">
            <Button
              size="lg"
